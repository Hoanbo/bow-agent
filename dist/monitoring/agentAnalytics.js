import { insertAnalyticsEvent } from './agentEvents.js';
import { isAmbiguousDemandQuery } from '../core/intentResolver.js';
/**
 * Chuẩn hóa nhu cầu người dùng và phân loại thành 4 trạng thái:
 * SUPPORTED | NEAR_MATCH | UNSUPPORTED | AMBIGUOUS
 */
export function normalizeUserDemand(rawText, matchedProducts = [], isAmbiguous = false) {
    ...
    if (lower.includes('video từ chữ') ||
