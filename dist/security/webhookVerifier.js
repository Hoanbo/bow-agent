...
export class WebhookVerifier {
    ...
    maxAgeSeconds;
    seenNonces = new Map();
    constructor(secret, maxAgeSeconds = 300) {
        this.secret = secret;
...
export const globalWebhookVerifier = new WebhookVerifier(process.env.BOW_SHOP_WEBHOOK_SECRET || 'bow_webhook_secret_default');
