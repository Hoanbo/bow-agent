...
export const fallbackShopAdapter = {
    catalog: {
        ...
        getPlanPrice: async (productId, durationTag) => {
...
export class ShopOfBowCommerceProvider {
    id = 'shopofbow';
    domainName = 'Shop of BOW Retail';
    _adapter;
    get adapter() {
