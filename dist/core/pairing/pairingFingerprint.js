 ...
 */
export function canonicalizePairingData(val) {
 ...
 */
export function computePairingDigest(data) {
 ...
 */
export function computeCapabilityFingerprint(capabilities) {
 ...
 */
export function computePairingFingerprint(data) {
