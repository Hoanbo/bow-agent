 ...
 */
export function preserveRisk(planningRisk, candidateRisk) {
    if (!candidateRisk)
        return planningRisk;
 ...
 */
export function isGovernedRisk(risk) {
 ...
 */
export function isApprovalRequiredForRisk(risk, planRequiresApproval) {
