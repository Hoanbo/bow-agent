 ...
 */
function computeDeterministicFingerprint(text) {
    let hash = 2166136261;
...
export class DecisionService {
    ...
    decide(input) {
        ...
        const confidence = bounded(selection.selected ? selection.selected.score : context.semanticIntent.confidence);
        ...
        const rationale = createRationale(requiresClarification ? undefined : selection.selected, selection.candidates);
