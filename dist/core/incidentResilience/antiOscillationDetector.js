...
import { createOscillationEventId, } from './incidentResilienceTypes.js';
export class AntiOscillationDetector {
     ...
     */
    computeSignature(targetId, category, primarySubsystem) {
     ...
     */
    recordAndEvaluate(event, now = Date.now()) {
        // 1. Ingest event
        // 1. Thu nạp sự kiện
