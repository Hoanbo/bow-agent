 ...
 */
export const VALID_CONNECTION_TRANSITIONS = Object.freeze({
    DISCONNECTED: Object.freeze(new Set(['CONNECTING', 'BLOCKED'])),
    CONNECTING: Object.freeze(new Set(['CONNECTED', 'FAILED', 'BLOCKED'])),
    CONNECTED: Object.freeze(new Set(['DEGRADED', 'RECONNECTING', 'CLOSING', 'FAILED', 'BLOCKED'])),
    DEGRADED: Object.freeze(new Set(['CONNECTED', 'RECONNECTING', 'CLOSING', 'FAILED', 'BLOCKED'])),
    RECONNECTING: Object.freeze(new Set(['RESUMING', 'FAILED', 'BLOCKED', 'DISCONNECTED'])),
    RESUMING: Object.freeze(new Set(['CONNECTED', 'FAILED', 'BLOCKED'])),
    CLOSING: Object.freeze(new Set(['CLOSED', 'FAILED'])),
    CLOSED: Object.freeze(new Set(['CONNECTING', 'DISCONNECTED'])),
    FAILED: Object.freeze(new Set(['CONNECTING', 'DISCONNECTED'])),
 ...
 */
export function isValidConnectionTransition(from, to) {
    if (from === to)
        return true;
 ...
 */
export function assertValidConnectionTransition(from, to) {
    if (!isValidConnectionTransition(from, to)) {
        throw new Error(`[TransportTransitions] Invalid connection transition from '${from}' to '${to}'.`);
    }
}
/**
 ...
 */
export const VALID_DELIVERY_TRANSITIONS = Object.freeze({
    CREATED: Object.freeze(new Set(['VALIDATED', 'REJECTED', 'FAILED'])),
    VALIDATED: Object.freeze(new Set([
        'QUEUED',
        'DISPATCHABLE',
        'DUPLICATE',
        'CONFLICTED',
    ...
    DISPATCHABLE: Object.freeze(new Set([
        'SENT',
        'TIMED_OUT',
        'STALE',
        'SUPERSEDED',
    ...
    ACKNOWLEDGED: Object.freeze(new Set([])),
    REJECTED: Object.freeze(new Set([])),
    TIMED_OUT: Object.freeze(new Set([])),
    STALE: Object.freeze(new Set([])),
    DUPLICATE: Object.freeze(new Set([])),
 ...
 */
export function assertValidDeliveryTransition(from, to) {
    if (!isValidDeliveryTransition(from, to)) {
        throw new Error(`[TransportTransitions] Invalid delivery transition from '${from}' to '${to}'.`);
    }
}
