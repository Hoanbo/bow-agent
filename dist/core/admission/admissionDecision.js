 ...
 */
export function createAdmissionDecision(params) {
...
export function createAdmitDecision(request, assignedSessionId, allowedCapabilities, timestamp) {
...
export function createRejectDecision(request, reason, details, timestamp) {
    return createAdmissionDecision({
        request,
        decision: 'REJECT',
        admitted: false,
...
export function createChallengeRequiredDecision(request, challenge, timestamp) {
    return createAdmissionDecision({
        request,
