...
import { GROUNDED_PLAN_TASK_SCHEMA_VERSION, GroundedPlanTaskUserStopError, computeStepBindingHash, computeBindingProvenanceHash, } from './groundedPlanTaskTypes.js';
...
export class GroundedPlanTaskAdapter {
    ...
    adaptPlanToTaskBinding(plan) {
        ...
        const taskSpecification = Object.freeze({
     ...
     */
    adaptStep(step, bindingId, index) {
        ...
        const taskStepOptions = Object.freeze({
            ...
            requiresApproval: step.riskLevel === 'CRITICAL' ||
                step.riskLevel === 'HIGH' ||
     ...
     */
    mapIntentToCapabilityAction(step) {
