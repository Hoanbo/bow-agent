 ...
 */
export function validatePersistentDeviceTrust(record, targetScope, currentTime) {
 ...
 */
export function isDeviceSessionEligible(recordOrState, currentTime) {
 ...
 */
export function assertDeviceTrusted(record, targetScope, currentTime) {
