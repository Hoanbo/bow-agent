...
import { updatePersistentDeviceTrustRecord, markPersistentDeviceRotationRequired, } from './persistentDeviceRecord.js';
 ...
 */
export function requireKeyRotation(store, deviceId, scopeString, timestamp) {
 ...
 */
export function rotatePersistentDeviceKey(store, keyStore, deviceId, scopeString, timestamp) {
    ...
    const updatedRecord = updatePersistentDeviceTrustRecord(record, 'TRUSTED', {
        publicKeyId: newKey.keyId,
        keyVersion: newKeyVersion,
