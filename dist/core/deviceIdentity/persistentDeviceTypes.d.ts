...
export declare const PERSISTENT_DEVICE_PROTOCOL_VERSION = "4.0.0";
/**
 * 16 Canonical Persistent Device States representing the full passwordless recognition lifecycle.
 */
export type PersistentDeviceState = 'UNSEEN' | 'IDENTITY_PRESENT' | 'PAIRING_REQUIRED' | 'PAIRING_PENDING' | 'PAIRED' | 'TRUST_PENDING' | 'TRUSTED' | 'RECOGNITION_CHALLENGE' | 'PROOF_RECEIVED' | 'PROOF_VERIFIED' | 'RECOGNIZED' | 'SESSION_ELIGIBLE' | 'REVOKED' | 'ROTATION_REQUIRED' | 'EXPIRED' | 'FAILED';
export declare const ALL_PERSISTENT_DEVICE_STATES: readonly PersistentDeviceState[];
/**
 * Lifecycle state of cryptographic key material associated with a persistent device.
 */
export type DeviceKeyState = 'ACTIVE' | 'ROTATION_REQUIRED' | 'ROTATED' | 'REVOKED' | 'EXPIRED';
export declare const ALL_DEVICE_KEY_STATES: readonly DeviceKeyState[];
/**
 ...
 */
export type PersistentDeviceAuditEventType = 'DEVICE_IDENTITY_CREATED' | 'DEVICE_PERSISTED' | 'DEVICE_REHYDRATED' | 'DEVICE_LOOKUP' | 'TRUST_LOOKUP' | 'RECOGNITION_CHALLENGE_CREATED' | 'DEVICE_PROOF_RECEIVED' | 'DEVICE_PROOF_VERIFIED' | 'DEVICE_RECOGNIZED' | 'DEVICE_RECOGNITION_FAILED' | 'DEVICE_REVOKED' | 'DEVICE_KEY_ROTATION_REQUIRED' | 'DEVICE_KEY_ROTATED' | 'DEVICE_SCOPE_MISMATCH' | 'DEVICE_PROOF_REPLAY' | 'DEVICE_PROOF_INVALID' | 'DEVICE_TRUST_EXPIRED';
/**
 ...
 */
export type DeviceIdentityErrorCode = 'DEVICE_INVALID_REQUEST' | 'DEVICE_IDENTITY_MISMATCH' | 'DEVICE_SCOPE_MISMATCH' | 'DEVICE_KEY_INVALID' | 'DEVICE_KEY_ROTATION_REQUIRED' | 'DEVICE_KEY_EXPIRED' | 'DEVICE_KEY_REVOKED' | 'DEVICE_CHALLENGE_EXPIRED' | 'DEVICE_CHALLENGE_MISMATCH' | 'DEVICE_PROOF_INVALID' | 'DEVICE_PROOF_REPLAY' | 'DEVICE_PROOF_EXPIRED' | 'DEVICE_NOT_FOUND' | 'DEVICE_NOT_TRUSTED' | 'DEVICE_REVOKED' | 'DEVICE_CLONE_DETECTED' | 'DEVICE_REHYDRATION_FAILED' | 'DEVICE_INVALID_TRANSITION';
