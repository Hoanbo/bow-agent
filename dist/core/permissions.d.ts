...
export type AgentToolName = 'searchProducts' | 'getMyOrders' | 'getMyTickets' | 'checkWarrantyPolicy' | 'searchPromptsLibrary' | 'getActiveCoupons' | 'getMyWalletBalance' | 'getFaqsAndGuides' | 'getSupportChannels' | 'desktop_action';
/**
