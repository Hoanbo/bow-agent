...
export class PolicyEvolutionConstraintEngine {
     ...
     */
    evaluateCandidateConstraints(draft) {
        ...
        if (draft.promoteToGlobal === true || draft.isPromoted === true) {
        ...
        if (draft.issuedTokenId || draft.authorizationToken) {
        ...
        if (draft.modifiedAuditHistory || draft.tamperProvenance) {
