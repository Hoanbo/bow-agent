...
export class PolicyCandidateSynthesisEngine {
    ...
    getTenantDrafts(tenantPartition) {
     ...
     */
    synthesizeCandidateDraft(input) {
        // 1. USER_STOP check
     ...
     */
    getCandidateDraftByPlanId(tenantPartition, planId) {
        this.assertUserStopInactive();
        this.validateTenant(tenantPartition);
        return this.getTenantDrafts(tenantPartition).get(planId);
    }
}
