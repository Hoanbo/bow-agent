...
import { computeBlastRadiusHash, EmergencyStopActiveError, CrossTenantAccessForbiddenError, } from './GovernedPolicyRemediationTypes.js';
export class PolicyBlastRadiusRiskAnalyzer {
    ...
    evaluateBlastRadius(tenantId, policyDomain, diagnosis, impactInput) {
        ...
        if (diagnosis.tenantId !== tenantId) {
            throw new CrossTenantAccessForbiddenError(`Cross-tenant diagnosis record injection: expected '${tenantId}', got '${diagnosis.tenantId}'`);
        }
