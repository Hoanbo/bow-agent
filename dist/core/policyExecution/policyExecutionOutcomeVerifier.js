...
import { createExecutionOutcomeId, } from './policyExecutionTypes.js';
...
export class PolicyExecutionOutcomeVerifier {
    ...
    verifyOutcome(receipt) {
        ...
        const verificationId = createExecutionOutcomeId(`out_${Date.now()}_${crypto.randomBytes(4).toString('hex')}`);
