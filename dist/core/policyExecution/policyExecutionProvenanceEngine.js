...
import { createExecutionProvenanceId, } from './policyExecutionTypes.js';
...
export class PolicyExecutionProvenanceEngine {
    ...
    recordTransition(input) {
        ...
        const provenanceId = createExecutionProvenanceId(`ex_prv_${Date.now()}_${crypto.randomBytes(4).toString('hex')}`);
