...
import { createHealthReportId, } from './observabilityTypes.js';
export class SupervisorHealthReportEngine {
    ...
    generateReport(input) {
        ...
        const reportId = createHealthReportId(`report_${input.sessionId}_${generatedAt}_${crypto.randomBytes(4).toString('hex')}`);
