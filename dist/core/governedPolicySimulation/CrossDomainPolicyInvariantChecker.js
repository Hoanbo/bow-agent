...
import { EmergencyStopActiveError, computeInvariantCheckHash, } from './GovernedPolicySimulationTypes.js';
export class CrossDomainPolicyInvariantChecker {
    ...
    assertEmergencyStopInactive() {
        ...
        try {
            ...
            throw new EmergencyStopActiveError(`Emergency stop provider threw error during invariant checking: ${err instanceof Error ? err.message : String(err)}`);
        }
     ...
     */
    verifyDomainInvariants(dependencies) {
