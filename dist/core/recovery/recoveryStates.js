 ...
 */
export const RECOVERY_OPERATIONAL_STATES = Object.freeze(new Set([
    'RECOVERY_REQUIRED',
    'RECOVERY_INSPECTING',
 ...
 */
export const RECOVERY_TERMINAL_STATES = Object.freeze(new Set([
    'RECOVERY_COMPLETED',
    'RECOVERY_FAILED',
    'RECOVERY_BLOCKED',
    'RECOVERY_STOPPED',
 ...
 */
export const RECOVERY_BLOCKED_STATES = Object.freeze(new Set([
    'RECOVERY_BLOCKED',
    'RECOVERY_FAILED',
]));
/**
 ...
 */
export function isRecoveryOperationalState(state) {
 ...
 */
export function isRecoveryTerminalState(state) {
 ...
 */
export function isRecoveryBlockedState(state) {
