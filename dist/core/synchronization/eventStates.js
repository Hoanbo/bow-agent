 ...
 */
export const TERMINAL_EVENT_STATES = Object.freeze(new Set([
    'REJECTED',
    'STALE',
    'CONFLICTED',
    'SUPERSEDED',
 ...
 */
export const ACTIVE_EVENT_STATES = Object.freeze(new Set([
    'CREATED',
    'VALIDATED',
    'PUBLISHED',
    'OBSERVED',
 ...
 */
export const OBSERVATION_EVENT_STATES = Object.freeze(new Set([
    'OBSERVED',
    'ACKNOWLEDGED',
]));
/**
 ...
 */
export function isEventTerminal(state) {
 ...
 */
export function isEventAcknowledged(state) {
