...
import { createQualityReportId, } from './qualityTypes.js';
export class QualityReportEngine {
     ...
     */
    static hashReport(reportId, evidenceId, gateId, overallState, manifestHash, evidenceHash, gateEvaluationHash) {
     ...
     */
    createReport(input) {
        const reportId = createQualityReportId(`qrep_${crypto.randomUUID()}`);
        ...
        const reportHash = QualityReportEngine.hashReport(reportId, input.evidenceBundle.evidenceId, input.gateEvaluation.gateId, overallState, input.evidenceBundle.manifestHash, input.evidenceBundle.evidenceHash, input.gateEvaluation.evaluationHash);
