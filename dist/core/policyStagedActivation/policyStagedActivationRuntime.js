...
export class PolicyStagedActivationRuntime {
    ...
    stagePolicy(params) {
        ...
        // 3. Provenance record
        this.provenanceEngine.appendEvent(stagedPolicy.tenantPartition, stagedPolicy.candidateDraftId, 'POLICY_STAGED', {
    ...
    runPreflight(stagedPolicy) {
        ...
        this.provenanceEngine.appendEvent(stagedPolicy.tenantPartition, stagedPolicy.candidateDraftId, 'ACTIVATION_PREFLIGHT_EXECUTED', {
            stagedActivationId: stagedPolicy.stagedActivationId,
    ...
    authorizeActivation(params) {
        ...
        this.provenanceEngine.appendEvent(params.stagedPolicy.tenantPartition, params.stagedPolicy.candidateDraftId, 'ACTIVATION_BOUNDARY_AUTHORIZED', {
    ...
    commitActivation(params) {
        ...
        this.provenanceEngine.appendEvent(activePolicy.tenantPartition, activePolicy.candidateDraftId, 'ACTIVATION_COMMITTED', {
