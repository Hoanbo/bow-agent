...
import { createActivationCommitId, createActivePolicyStateId, } from './policyStagedActivationTypes.js';
...
export class PolicyActiveStateTransitionEngine {
    ...
    commitActivation(params) {
        ...
        const provenanceHeadHash = crypto.createHash('sha256')
            ...
            .digest('hex');
        const activePolicyState = Object.freeze({
            activePolicyStateId,
            activationCommitId,
            stagedActivationId: params.stagedPolicy.stagedActivationId,
        ...
        const committedStaged = Object.freeze({
            ...params.stagedPolicy,
