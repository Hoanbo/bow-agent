...
export class WorldActionVerifier {
     ...
     */
    static async verifyFsWrite(action, execResult) {
     ...
     */
    static async verifyFsAppend(action, execResult) {
        const verifiedAt = Date.now();
        const checksPerformed = [];
        if (action.isDryRun) {
            return {
     ...
     */
    static async verifyFsMkdir(action, execResult) {
        const verifiedAt = Date.now();
        const checksPerformed = [];
        if (action.isDryRun) {
            return {
     ...
     */
    static async verifyFsRename(action, execResult) {
        const verifiedAt = Date.now();
        const checksPerformed = [];
        if (action.isDryRun) {
            return {
     ...
     */
    static async verifyFsDelete(action, execResult) {
        const verifiedAt = Date.now();
        const checksPerformed = [];
        if (action.isDryRun) {
            return {
     ...
     */
    static async verifyProcessStart(action, execResult) {
        const verifiedAt = Date.now();
        const checksPerformed = [];
        if (action.isDryRun) {
            return {
     ...
     */
    static async verifyProcessStop(action, execResult) {
        const verifiedAt = Date.now();
        const checksPerformed = [];
        if (action.isDryRun) {
            return {
     ...
     */
    static async verifyObservation(action, execResult) {
        return {
