...
export type ContinuousLoopState = 'BOOTING' | 'SELF_CHECK' | 'READY' | 'OBSERVING' | 'STATE_RECONSTRUCTION' | 'REASONING' | 'PLANNING' | 'GOVERNANCE_CHECK' | 'WAITING_FOR_AUTHORIZATION' | 'AUTHORIZED' | 'EXECUTING' | 'VERIFYING' | 'EVALUATING' | 'RECOVERING' | 'ESCALATING' | 'PAUSED' | 'STOPPING' | 'STOPPED' | 'FAILED';
...
export type ObjectiveStatus = 'PENDING' | 'ACTIVE' | 'BLOCKED' | 'COMPLETED' | 'FAILED' | 'CANCELLED';
...
export type ControlCommandType = 'USER_COMMAND' | 'USER_APPROVE' | 'USER_DENY' | 'USER_STOP' | 'USER_PAUSE' | 'USER_RESUME' | 'USER_RESET';
...
export type LoopFailureCode = 'INITIALIZATION_FAILED' | 'SELF_CHECK_FAILED' | 'OBSERVATION_FAILED' | 'REASONING_FAILED' | 'PLANNING_FAILED' | 'GOVERNANCE_DENIED' | 'AUTHORIZATION_DENIED' | 'AUTHORIZATION_TIMEOUT' | 'EXECUTION_FAILED' | 'VERIFICATION_FAILED' | 'RECOVERY_EXHAUSTED' | 'USER_STOP_TRIGGERED' | 'STALE_STATE_DETECTED' | 'RESOURCE_LOCK_CONFLICT' | 'CORRUPTED_CHECKPOINT' | 'INTERNAL_ERROR';
