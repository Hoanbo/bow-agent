...
import { segmentSpeech } from './speechSegmenter.js';
import { planProsody } from './voiceProsody.js';
 ...
 */
export function processTextForSpeech(text, options = {}) {
 ...
 */
export function processAndPlanSpeech(text, options = {}) {
