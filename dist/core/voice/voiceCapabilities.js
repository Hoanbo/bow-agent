 ...
 */
export function negotiateCapabilities(capabilities, config, requestContext) {
    const unsupported = [];
    // 1. Language check
    ...
    const useSentenceLevel = Boolean((requestContext?.wantsSentenceLevel || config.enableSentenceLevel) &&
