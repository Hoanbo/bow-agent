...
export type SupervisorRuntimeState = 'INITIALIZING' | 'OBSERVING' | 'HEALTHY' | 'ANOMALY_DETECTED' | 'DIAGNOSING' | 'RECOVERY_PLANNING' | 'POLICY_EVALUATION' | 'WAITING_FOR_HUMAN' | 'AUTHORIZED' | 'RECOVERING' | 'VERIFYING' | 'RECOVERY_SUCCEEDED' | 'RECOVERY_FAILED' | 'ESCALATED' | 'SAFE_STOP' | 'STOPPED';
export type AnomalySeverity = 'INFO' | 'LOW' | 'MEDIUM' | 'HIGH' | 'CRITICAL';
export type SupervisorAnomalyType = 'PROCESS_UNEXPECTED_EXIT' | 'CAPABILITY_DEGRADED' | 'CAPABILITY_UNAVAILABLE' | 'COGNITIVE_PROVIDER_UNAVAILABLE' | 'COGNITIVE_CIRCUIT_BREAKER_OPEN' | 'WORLDACTION_EXECUTION_FAILURE' | 'WORLDACTION_VERIFICATION_FAILURE' | 'RESOURCE_LOCK_STUCK' | 'HOST_RESOURCE_EXHAUSTION' | 'BRAIN_STATE_INCONSISTENT' | 'UNKNOWN_ANOMALY';
...
export type RecoveryClass = 'AUTO_SAFE' | 'AUTO_REVERSIBLE' | 'HUMAN_REQUIRED' | 'CRITICAL_BLOCKED' | 'UNRECOVERABLE';
