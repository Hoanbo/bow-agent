...
export class PolicyFeedbackHumanReviewGate {
    ...
    getTenantDecisions(tenantPartition) {
     ...
     */
    evaluateSubmission(entry, submission) {
     ...
     */
    getRecordedDecision(tenantPartition, reviewId) {
        this.assertUserStopInactive();
        this.validateTenant(tenantPartition);
        return this.getTenantDecisions(tenantPartition).get(reviewId);
    }
}
