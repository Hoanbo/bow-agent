...
export class ConnectionSequenceTracker {
    ...
    seenInboundFingerprints = new Set();
    constructor(expectedScope, initialInboundSequence = 0, initialOutboundSequence = 0) {
    ...
    getLastInboundSequence() {
        return this.lastInboundSequence;
    }
    getLastOutboundSequence() {
