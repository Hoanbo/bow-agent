 ...
 */
export function createConnectionReconnectRequest(identity, sessionId, peerId, lastReceivedSequence, lastSentSequence) {
 ...
 */
export function evaluateConnectionReconnect(prevSnapshot, req) {
