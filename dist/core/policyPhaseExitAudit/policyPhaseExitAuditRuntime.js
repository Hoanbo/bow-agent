...
// - FAIL_CLOSED
import { createAuditEvidenceId, createAuditCriterionId, } from './policyPhaseExitAuditTypes.js';
...
export class PolicyPhaseExitAuditRuntime {
    ...
    isolationInspector;
    provenanceInspector;
    antiCircularityEngine;
    assessmentEngine;
    store;
    auditProvenanceEngine;
    auditEngine;
    isUserStopActiveFn;
    constructor(options) {
    ...
    executeIndependentAudit(params) {
        ...
        const evidenceItems = [...baselineBundle.evidenceItems];
        ...
        for (const cName of remainingCriteria) {
            let strength = 'DIRECT_TEST_EVIDENCE';
            let method = 'DEDICATED_REALITY_TEST';
     ...
     */
    getReport(tenantPartition, reportId) {
        this.assertUserStopInactive();
     ...
     */
    verifyAuditProvenance(tenantPartition) {
        this.assertUserStopInactive();
