...
import { VisionUserStopError, CrossTenantVisionError, } from './visionTypes.js';
...
export class VisualSecurityBoundary {
     ...
     */
    assertUserStopNotActive(checkpoint) {
     ...
     */
    quarantineScreenText(frameId, rawText) {
     ...
     */
    sanitizeVisualElements(elements) {
