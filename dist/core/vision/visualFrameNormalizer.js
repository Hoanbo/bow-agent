...
export class VisualFrameNormalizer {
     ...
     */
    static normalizeCoordinates(x, y, width, height, viewport) {
     ...
     */
    static computeCentroid(box, viewport) {
     ...
     */
    static denormalizeToViewport(normX, normY, normWidth, normHeight, targetViewport) {
