...
import { createDecisionProvenanceId, } from './policyDecisionTypes.js';
...
export class PolicyDecisionProvenanceEngine {
    ...
    recordTransition(input) {
        ...
        const provenanceId = createDecisionProvenanceId(`dprov_${Date.now()}_${crypto.randomBytes(4).toString('hex')}`);
