...
export class CapabilityDiscoveryBridge {
     ...
     */
    discoverCapability(query, customHost) {
        ...
        if (descriptor.supportedOperatingSystems &&
     ...
     */
    discoverAllCapabilities(customHost) {
        const host = customHost || globalHostDiscovery.discoverHost();
     ...
     */
    assessPlanFeasibility(planId, requiredCapabilityIds, customHost) {
        const host = customHost || globalHostDiscovery.discoverHost();
