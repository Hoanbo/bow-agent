 ...
 */
export type CoordinationFailureCategory = 'COORDINATION_SCOPE_FAILURE' | 'COORDINATION_CONFLICT' | 'STALE_COORDINATION_STATE' | 'SURFACE_UNAVAILABLE' | 'CROSS_USER_HANDOFF_REJECTED' | 'CROSS_SESSION_HANDOFF_REJECTED' | 'CROSS_BRAIN_HANDOFF_REJECTED' | 'RISK_DOWNGRADE_REJECTED' | 'SURFACE_INVALID_TRANSITION' | 'INTERNAL_COORDINATION_FAILURE';
/**
