 ...
 */
export function createSurface(surfaceType, name, capabilities) {
    const resolvedCaps = deepFreeze({
 ...
 */
export function createActiveSurface(surface, status, sessionId, sequence) {
    return deepFreeze({
