 ...
 */
export function detectSplitBrainConflict(current, incoming) {
    // If identities match but continuity details diverge at same sequence
    if (current.brainId === incoming.brainId &&
 ...
 */
export function detectStaleUpdate(currentSequence, incomingSequence) {
