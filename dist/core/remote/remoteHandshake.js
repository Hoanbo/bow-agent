...
import { computeHandshakeFingerprint, fnv1aHex, } from './remoteFingerprint.js';
import { validateRemoteScope, validateRemoteIdentifier, validateRemotePayloadBounds, deepFreeze, redactRemoteSecrets, } from './remoteValidator.js';
 ...
 */
export function createRemoteHandshake(params) {
 ...
 */
export function evaluateRemoteHandshake(handshake, gateway, timestamp = 0) {
    // 1. Gateway ID match
