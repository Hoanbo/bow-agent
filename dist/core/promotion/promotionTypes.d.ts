import type { SandboxId, WorktreeId, SandboxChange } from '../sandbox/sandboxTypes.js';
export declare const PROMOTION_SCHEMA_VERSION: "4.0.0";
/**
 ...
 */
export declare function createPromotionId(id: string): PromotionId;
/**
 * Lifecycle states of a promotion lifecycle.
 * Các trạng thái vòng đời của quy trình xúc tiến.
 */
export type PromotionState = 'DRAFT' | 'PROPOSED' | 'VALIDATING' | 'VALIDATED' | 'REVIEW_PENDING' | 'APPROVAL_PENDING' | 'APPROVED' | 'PROMOTING' | 'PROMOTED' | 'REJECTED' | 'BLOCKED' | 'CONFLICTED' | 'STALE' | 'ROLLED_BACK' | 'REVOKED' | 'EXPIRED' | 'FAILED' | 'CANCELLED';
/**
 ...
 */
export type PromotionConflictType = 'TARGET_MODIFIED_CONCURRENTLY' | 'BASE_HASH_MISMATCH' | 'FILE_CONTENT_COLLISION' | 'DELETED_FILE_MODIFIED_IN_TARGET' | 'RENAMED_FILE_MISSING_IN_TARGET' | 'OVERLAPPING_PROMOTION_ACTIVE' | 'STALE_SOURCE_DIFF';
/**
