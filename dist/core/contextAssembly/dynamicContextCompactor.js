...
import { ContextTier, ContextBudgetExceededError, } from './contextTypes.js';
export class DynamicContextCompactor {
     ...
     */
    compact(fragments, onStageChange) {
            ...
            for (const frag of currentFragments) {
                if (frag.tier === ContextTier.TIER_3_MEDIUM) {
                    ...
                    if (frag.canDrop && frag.priority < 55) {
                        ...
                        compactedCount++;
                        compactedTier3.push(Object.freeze({
                            ...frag,
                            content: condensed,
            ...
            for (const frag of currentFragments) {
                if (frag.tier === ContextTier.TIER_2_HIGH && frag.canTruncate) {
                    ...
                    if (truncated.length < frag.content.length) {
                        ...
                        truncatedTier2.push(Object.freeze({
                            ...frag,
                            content: truncated,
                            tokenEstimate: newTokenEstimate,
                        }));
        ...
        if (finalTokens > budget.maxPromptTokens) {
            ...
            if (remainingTokensWithoutTier3 <= budget.maxPromptTokens) {
                ...
                throw new ContextBudgetExceededError(budget.maxPromptTokens, finalTokens, {
                    originalTokens,
                    finalTokens,
                    droppedCount,
                    compactedCount,
     ...
     */
    truncateTier2Content(content, maxChars) {
