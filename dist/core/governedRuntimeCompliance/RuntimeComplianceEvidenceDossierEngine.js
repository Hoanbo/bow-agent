...
import { computeDossierFingerprint, computeSha256, } from './GovernedRuntimeComplianceTypes.js';
export class RuntimeComplianceEvidenceDossierEngine {
    ...
    compileDossier(tenantId, assurance, violations, policyVersion, canonicalPolicyHash) {
        ...
        const dossierId = `dos_comp_${computeSha256(rawDossierId).slice(0, 16)}`;
        ...
        const fullDossier = Object.freeze({
            ...partialDossier,
            sha256Fingerprint,
        });
        return fullDossier;
