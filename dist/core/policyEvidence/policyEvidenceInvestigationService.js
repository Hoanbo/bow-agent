...
import { globalPolicyEvidenceQueryEngine } from './policyEvidenceQueryEngine.js';
import { globalPolicyLifecycleTraceEngine } from './policyLifecycleTraceEngine.js';
import { globalPolicyAuditCorrelationEngine } from './policyAuditCorrelationEngine.js';
import { globalPolicyEvidenceIntegrityVerifier } from './policyEvidenceIntegrityVerifier.js';
...
export class PolicyEvidenceInvestigationService {
     ...
     */
    getPolicyLifecycleTrace(tenantPartition, candidateId) {
        this.assertUserStopInactive();
     ...
     */
    correlateAudit(tenantPartition, candidateId) {
        this.assertUserStopInactive();
        this.validateTenant(tenantPartition);
     ...
     */
    verifyIntegrity(tenantPartition, candidateId) {
        this.assertUserStopInactive();
        this.validateTenant(tenantPartition);
     ...
     */
    getInvestigationSummary(tenantPartition, candidateId) {
        this.assertUserStopInactive();
        this.validateTenant(tenantPartition);
