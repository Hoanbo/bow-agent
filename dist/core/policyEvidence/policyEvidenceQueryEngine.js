...
import { createEvidenceQueryId, } from './policyEvidenceQueryTypes.js';
...
export class PolicyEvidenceQueryEngine {
     ...
     */
    queryByCorrelationId(tenantPartition, correlationId, limit) {
     ...
     */
    queryByCandidate(tenantPartition, candidateId, limit) {
        return this.queryEvidence({
            tenantPartition,
            candidateId,
            limit: limit ?? this.defaultLimit,
