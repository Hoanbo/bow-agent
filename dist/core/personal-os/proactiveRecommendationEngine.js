...
import { ACTION_CLASS_POLICIES, generatePersonalOsId, MASTER_OWNER_ID, } from './personalOsTypes';
export class ProactiveRecommendationEngine {
     ...
     */
    scanAndGenerateRecommendations(context) {
        const generated = [];
        ...
        if (context.contradictions && context.contradictions.length > 0) {
            ...
            for (const c of unres) {
                generated.push(this.createRecommendation({
                    ownerId,
     ...
     */
    resolveRecommendation(recommendationId, status) {
