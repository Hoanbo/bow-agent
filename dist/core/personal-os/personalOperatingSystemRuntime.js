...
import { MASTER_OWNER_ID, assertMasterOwner, } from './personalOsTypes';
...
import { DecisionHistoryEngine } from './decisionHistoryEngine';
...
export class PersonalOperatingSystemRuntime {
     ...
     */
    async executeCognitiveLoop(ownerId = MASTER_OWNER_ID) {
     ...
     */
    getOwnerBriefing(ownerId = MASTER_OWNER_ID) {
     ...
     */
    evaluateGoalIntelligence(ownerId, input) {
     ...
     */
    emergencyStop(ownerId = MASTER_OWNER_ID) {
     ...
     * Pause / resume.
     */
    setPaused(paused, ownerId = MASTER_OWNER_ID) {
