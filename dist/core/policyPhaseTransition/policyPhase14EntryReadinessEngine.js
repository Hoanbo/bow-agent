...
import { createPhase14EntryReadinessId, } from './policyPhaseTransitionTypes.js';
export const CANONICAL_PHASE_1_4_PREREQUISITES = Object.freeze([
...
export class PolicyPhase14EntryReadinessEngine {
    ...
    evaluateEntryReadiness(params) {
        ...
        const readinessId = createPhase14EntryReadinessId(`readiness_14_${tenantId}_${Date.now()}_${Math.random().toString(36).substring(2, 8)}`);
        return Object.freeze({
            readinessId,
            tenantId,
