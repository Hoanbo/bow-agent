...
import { createPhaseExitCandidateId, } from './policyPhaseTransitionTypes.js';
...
export class PolicyPhaseExitReviewEngine {
    ...
    generateExitCandidate(params) {
        ...
        const candidateId = createPhaseExitCandidateId(`cand_exit_${params.report.tenantId}_${Date.now()}_${Math.random().toString(36).substring(2, 8)}`);
        ...
        const humanReviewChecklist = Object.freeze([
