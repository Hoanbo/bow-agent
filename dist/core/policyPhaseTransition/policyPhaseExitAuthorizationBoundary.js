...
import { createPhaseExitAuthorizationId, } from './policyPhaseTransitionTypes.js';
...
export class PolicyPhaseExitAuthorizationBoundary {
     ...
     */
    authorizePhaseExit(candidate, request) {
        ...
        const authorizationId = createPhaseExitAuthorizationId(`auth_exit_${request.tenantId}_${Date.now()}_${Math.random().toString(36).substring(2, 8)}`);
