...
import { createPhaseExitCommitId, } from './policyPhaseTransitionTypes.js';
export class PolicyPhaseExitTransitionEngine {
    ...
    commitPhaseExit(params) {
        ...
        const commitId = createPhaseExitCommitId(`commit_exit_${candidate.tenantId}_${Date.now()}_${Math.random().toString(36).substring(2, 8)}`);
