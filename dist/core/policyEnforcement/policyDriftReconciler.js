...
import { createDriftReportId, } from './policyEnforcementTypes.js';
export class PolicyDriftReconciler {
     ...
     */
    reconcileTenantPolicy(userId, tenantPartition) {
        ...
        if (versionMismatch || checksumMismatch) {
            ...
            this.hotSwapEngine.resetToBaseline(tenantPartition, `POLICY_DRIFT_DETECTED: VersionMismatch=${versionMismatch}, ChecksumMismatch=${checksumMismatch}`);
            return {
                reportId,
                tenantPartition,
                hasDrift: true,
