...
import { MAX_SHADOW_EVAL_TRACES, computeShadowEvaluationReportHash, } from './GovernedPolicyDecisionIngestionTypes.js';
export class StrategicPolicyShadowEvaluationEngine {
     ...
     */
    evaluateShadow(candidatePolicy, historicalTraces, maxPermittedDivergence = 0.5) {
    ...
    evaluateActionAgainstPolicy(action, params, policy) {
