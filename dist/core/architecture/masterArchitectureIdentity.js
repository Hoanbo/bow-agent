...
export const ECOSYSTEM_ID = 'BOW';
export const RUNTIME_IDENTITY = 'BOWCON';
export const CANONICAL_VERSION = '4.0.0';
export const CANONICAL_ARCHITECTURE_HIERARCHY = Object.freeze([
    {
        id: MASTER_OWNER_ID,
        name: 'Master Owner',
        tier: 'MASTER_OWNER',
...
export class MasterArchitectureIdentity {
    ...
    getCanonicalIdentity() {
        return {
            ...
            canonicalDefinition: 'Personal AI Cognitive & Autonomous Operating Runtime for the single Master Owner within the broader BOW personal ecosystem.',
        };
    }
    /**
     ...
     */
    verifyAuthorityRank(entityA, entityB) {
        const getRank = (entity) => {
            if (entity === this._masterOwnerId || isMasterOwner(entity))
                return 4;
            if (entity.toUpperCase() === ECOSYSTEM_ID)
                return 3;
            if (entity.toUpperCase() === RUNTIME_IDENTITY)
                return 2;
    ...
    validateTerminology(statement) {
        ...
        return {
            ...
            flaggedTerms,
            recommendation: flaggedTerms.length === 0
