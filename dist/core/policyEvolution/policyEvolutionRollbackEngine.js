...
import { createRollbackId, } from './policyEvolutionTypes.js';
import { PolicySnapshotStore } from './policySnapshotStore.js';
export class PolicyEvolutionRollbackEngine {
    snapshotStore;
    constructor(snapshotStore = new PolicySnapshotStore()) {
    ...
    executeRollback(input) {
        ...
        const restoredSnapshot = this.snapshotStore.rollbackToSnapshot(rolloutRecord.preRolloutSnapshotId, userId);
