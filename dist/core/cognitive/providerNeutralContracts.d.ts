import type { CognitiveIntent, CognitiveRiskLevel, CognitiveDecisionType } from './cognitiveTypes.js';
export declare const PROVIDER_NEUTRAL_CONTRACT_VERSION = "1.5.01";
/**
 ...
 */
export type CognitiveFailureReason = 'TIMEOUT' | 'CONNECTION_REFUSED' | 'MODEL_NOT_FOUND' | 'CIRCUIT_OPEN' | 'MALFORMED_JSON' | 'SCHEMA_VALIDATION_FAILED' | 'CAPABILITY_UNSUPPORTED' | 'BUDGET_EXCEEDED' | 'USER_STOP_PREEMPTED' | 'AUTH_FAILED' | 'RATE_LIMITED' | 'UNKNOWN_ERROR';
/**
 ...
 */
export declare function computeProposalProvenanceHash(payload: {
    readonly proposalId: string;
    readonly providerName: string;
    readonly modelName: string;
 ...
 */
export declare function makeProposalId(): string;
