...
if (typeof window !== 'undefined') {
    window.__sessionContext = currentSessionContext;
    window.sessionContext = currentSessionContext;
}
/**
 ...
 */
export function updateSessionContext(partial) {
    const now = Date.now();
 ...
 */
export function rememberProductContext(product, plan) {
    ...
    const isNotInCurrentGroup = currentSessionContext.lastRecommendedCandidates &&
 ...
 */
export function rememberRecommendedCandidates(candidates) {
 ...
 */
export function resetPlanContext() {
    updateSessionContext({
 ...
 */
export function rememberOrderContext(order) {
    updateSessionContext({
 ...
 */
export function rememberCategoryContext(category) {
    updateSessionContext({
 ...
 */
export function rememberDeferredContext(deferred) {
    updateSessionContext({
