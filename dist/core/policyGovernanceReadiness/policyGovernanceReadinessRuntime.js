...
// - FAIL_CLOSED
import { createAssessmentId, } from './policyGovernanceReadinessTypes.js';
...
export class PolicyGovernanceReadinessRuntime {
    ...
    executeAssessment(options) {
        ...
        const assessmentId = createAssessmentId(`assess_${options.tenantId}_${Date.now()}_${Math.random().toString(36).substring(2, 8)}`);
