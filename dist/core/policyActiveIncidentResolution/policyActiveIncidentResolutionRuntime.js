...
export class PolicyActiveIncidentResolutionRuntime {
    ...
    // ============================================================================
    revalidateIncident(tenantPartition, incidentId) {
        this.assertUserStopInactive();
        if (!this.incidentStore) {
    ...
    // ============================================================================
    assessContainment(tenantPartition, incidentId) {
        this.assertUserStopInactive();
        if (!this.incidentStore) {
    ...
    authorizeRecovery(params) {
        this.assertUserStopInactive();
        const { tenantPartition, clearanceId, recoveryTargetVersion, operatorId, operatorRole, governanceRationale, originalRequesterId, } = params;
    ...
    // ============================================================================
    verifyRecovery(tenantPartition, handoffId) {
        this.assertUserStopInactive();
    ...
    closeIncident(params) {
        this.assertUserStopInactive();
        const { tenantPartition, resolutionId, operatorId, operatorRole, closureRationale, originalReporterId, } = params;
