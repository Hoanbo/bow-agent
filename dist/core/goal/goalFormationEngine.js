...
// COGNITION != AUTHORITY
import { GoalUserStopError, computeDeterministicGoalId, computeGoalHash, } from './goalTypes.js';
...
export class GoalFormationEngine {
     ...
     */
    formGoal(proposal, customCreatedAt) {
        ...
        const goalId = computeDeterministicGoalId(proposal.tenantId, proposal.sourceIntent, sanitizedTitle, createdAt);
        const draftGoal = {
            goalId,
