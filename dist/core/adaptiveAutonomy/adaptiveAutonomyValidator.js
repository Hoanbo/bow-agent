...
import { AdaptiveAutonomyValidationError, computeAuthorizationEnvelopeProvenanceHash, computeContinuitySnapshotHash, MAX_OPERATIONAL_CYCLES, MAX_RECOVERY_ATTEMPTS, MAX_ADAPTATION_ATTEMPTS, MAX_CONTINUITY_GENERATIONS, MAX_SESSION_DURATION_MS, } from './adaptiveAutonomyTypes.js';
...
export class AdaptiveAutonomyValidator {
     ...
     */
    validateAdaptationBoundary(boundary) {
     ...
     */
    validateContinuitySnapshot(snapshot) {
