...
export type RemediationPlanId = string & {
    readonly __brand: unique symbol;
};
export type RemediationExecutionId = string & {
    readonly __brand: unique symbol;
};
export type RemediationSnapshotId = string & {
    readonly __brand: unique symbol;
};
export declare function createRemediationPlanId(raw: string): RemediationPlanId;
export declare function createRemediationExecutionId(raw: string): RemediationExecutionId;
export declare function createRemediationSnapshotId(raw: string): RemediationSnapshotId;
/**
 ...
 */
export type RemediationLifecycleState = 'PENDING_AUTHORIZATION' | 'AUTHORIZED' | 'SNAPSHOTTING' | 'SNAPSHOT_READY' | 'EXECUTING' | 'VERIFYING' | 'SUCCESS' | 'ROLLING_BACK' | 'ROLLED_BACK' | 'FAILED' | 'ESCALATED' | 'ABORTED' | 'SECURITY_VIOLATION';
/**
 ...
 */
export type RemediationActionClass = 'ROLLBACK' | 'CONFIG_SYNC' | 'PROCESS_RESTART' | 'TRAFFIC_DRAIN';
/**
