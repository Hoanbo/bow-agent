...
export const VALID_NETWORK_CONNECTION_TRANSITIONS = new Map([
...
export const VALID_NETWORK_ADAPTER_TRANSITIONS = new Map([
...
export const VALID_NETWORK_HEARTBEAT_TRANSITIONS = new Map([
 ...
 */
export function isValidNetworkConnectionTransition(from, to) {
 ...
 */
export function assertValidNetworkConnectionTransition(from, to) {
    if (!isValidNetworkConnectionTransition(from, to)) {
        throw new Error(`[NETWORK_TRANSITION_VIOLATION] Invalid connection transition from "${from}" to "${to}". State machine fails closed.`);
    }
}
/**
 ...
 */
export function isValidNetworkAdapterTransition(from, to) {
 ...
 */
export function assertValidNetworkAdapterTransition(from, to) {
    if (!isValidNetworkAdapterTransition(from, to)) {
        throw new Error(`[NETWORK_TRANSITION_VIOLATION] Invalid adapter transition from "${from}" to "${to}". State machine fails closed.`);
    }
}
/**
 ...
 */
export function isValidNetworkHeartbeatTransition(from, to) {
 ...
 */
export function assertValidNetworkHeartbeatTransition(from, to) {
    if (!isValidNetworkHeartbeatTransition(from, to)) {
        throw new Error(`[NETWORK_TRANSITION_VIOLATION] Invalid heartbeat transition from "${from}" to "${to}". State machine fails closed.`);
    }
}
