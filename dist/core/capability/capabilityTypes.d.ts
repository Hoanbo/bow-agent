...
export type CapabilityCategory = 'OBSERVATION' | 'FILESYSTEM' | 'PROCESS' | 'SYSTEM' | 'NETWORK';
export type CapabilityState = 'AVAILABLE' | 'UNAVAILABLE' | 'DEGRADED' | 'REQUIRES_AUTHORIZATION' | 'REQUIRES_APPROVAL' | 'UNSUPPORTED' | 'DISABLED' | 'FAILED';
export type PermissionLevel = 'OBSERVE' | 'LOW_RISK' | 'REVERSIBLE' | 'ELEVATED' | 'HIGH_IMPACT' | 'CRITICAL';
export type HostMode = 'WORKSTATION' | 'SERVER' | 'HEADLESS_SERVER' | 'DEVELOPMENT' | 'PRODUCTION' | 'UNKNOWN';
