...
import { sanitizeActionText, calculateDecisionFingerprint } from './knowledgeActionService.js';
import { detectKnowledgeConflicts } from './knowledgeIntelligenceService.js';
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
export function evaluateGoldenQuery(testCase, classifierFn = classifyKnowledgeGap) {
...
// ---------------------------------------------------------------------------
export function testFaqIntegrity(faqs) {
...
export function testFaqConflict(faqs = [], policies = []) {
...
export function testNegativePolicyIntegrity(policies = []) {
...
export function testTransactionBoundary() {
...
export function testProductDemandBoundary() {
...
export function testWarrantyBoundary() {
...
export function testDurationInvariant() {
...
export function testPiiSanitization() {
    ...
    const pass = !clean.includes('user@test.com') &&
...
export function testDecisionMemory() {
...
export function testKnowledgeGapResolution() {
...
// ---------------------------------------------------------------------------
export async function runKnowledgeQaSuite(faqs = [], policies = []) {
