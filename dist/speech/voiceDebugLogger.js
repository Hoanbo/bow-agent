 ...
 */
export function logVoiceContent(correlationId, stage, content) {
    ...
    try {
        if (!fs.existsSync(DEBUG_LOG_DIR)) {
            ...
            fs.writeFileSync(path.join(DEBUG_LOG_DIR, '.gitignore'), '# DO NOT COMMIT — contains sensitive voice transcripts\n*\n');
        }
 ...
 */
export function purgeStaleVoiceDebugLogs() {
