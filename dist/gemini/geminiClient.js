...
export async function processAgentMessageWithGemini(userText, context) {
    ...
    try {
        ...
        const executionPromise = (async () => {
            ...
            const { actions, suggestions, primaryAction, responseData } = synthesizeActionsAndSuggestions(collectedToolOutputs, context, userText, sessionId);
 ...
 */
export function synthesizeActionsAndSuggestions(toolOutputs, context, userText, sessionId) {
    const actions = [];
    const suggestions = [];
