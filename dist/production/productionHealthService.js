...
import { getProductionMetrics, calculateTrafficStats, calculateLatencyStats } from './productionTelemetryService.js';
import { evaluateProductionSlo } from './productionSloService.js';
import { getCircuitBreakerState } from './productionCircuitBreaker.js';
import { getRolloutState } from './productionRolloutService.js';
import { getRollbackHistory } from './productionRollbackService.js';
import { getCapacityMetrics } from './productionCapacityService.js';
import { getActiveIncidents, hasOpenCriticalIncidents } from './productionIncidentService.js';
...
export function getProductionControlCenterSummary(forceRefresh = false) {
    const now = Date.now();
...
export function clearProductionSummaryCache() {
    cachedSummary = null;
