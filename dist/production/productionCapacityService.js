...
let rejectedCount = 0;
let timeoutCount = 0;
export function getCapacityStatus(requestsPerMinute) {
...
export function acquireCapacitySlot() {
...
export function releaseCapacitySlot() {
...
export function getCapacityMetrics(requestsPerMinute = 0, avgLatencyMs = 25) {
...
export function resetCapacityCounters() {
    concurrentCount = 0;
    peakTrafficRpm = 0;
    rejectedCount = 0;
    timeoutCount = 0;
