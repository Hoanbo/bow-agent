...
export class OledEmpathyEngine {
  private currentExpression: EmpathyExpressionState = {
    emotion: 'happy',
    intensity: 'normal',
   ...
   */
  public deduceExpressionFromContext(
    userText: string,
    agentReply: string,
    isBossChannel: boolean = true
  ): EmpathyExpressionState {
  ...
  public getCurrentExpression(): EmpathyExpressionState {
    return this.currentExpression;
  }
}
