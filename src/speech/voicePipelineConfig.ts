...
export const VOICE_CONFIG = {
   ...
   */
  get defaultCaptureDurationMs(): number {
  ...
  whisperModelPath: path.resolve(
    getEnvString('BOW_WHISPER_MODEL', 'artifacts/voice-benchmark/models-cache/whisper/ggml-base.bin')
  ),
   ...
   */
  piperModelPath: path.resolve(
    getEnvString(
      'BOW_PIPER_MODEL',
      'artifacts/voice-benchmark/models-cache/voice-07-duy-oryx/duyoryx3175.onnx'
    )
  ),
   ...
   */
  piperConfigPath: path.resolve(
    getEnvString(
      'BOW_PIPER_CONFIG',
      'artifacts/voice-benchmark/models-cache/voice-07-duy-oryx/duyoryx3175.onnx.json'
    )
  ),
