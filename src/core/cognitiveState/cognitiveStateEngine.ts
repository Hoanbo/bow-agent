...
import { CognitiveStatePromotionGate, type CognitivePromotionRequest, type CognitivePromotionApproval } from './cognitiveStatePromotionGate.js';
...
export class CognitiveStateEngine {
  public readonly store: WorkingRegisterStore;
  public readonly attentionManager: AttentionStateManager;
  public readonly persistence: CognitiveStatePersistenceEngine;
  public readonly recovery: CognitiveStateRecoveryEngine;
  public readonly gate: CognitiveStateExecutionGate;
   ...
   */
  public initializeSession(tenantId: string, sessionId: string, activeTenantId?: string): CognitiveStateRecoveryResult {
   ...
   */
  public getState(): CognitiveStateDocument {
   ...
   */
  public setAttentionTarget(
    target: AttentionTargetDescriptor | null,
    options: {
      readonly expectedVersion: number;
      readonly mutatedBy: string;
      readonly mutationReason: string;
   ...
   */
  public resumeAttention(options: {
    readonly expectedVersion: number;
    readonly mutatedBy: string;
    readonly mutationReason: string;
    readonly activeTenantId?: string;
  }): { readonly resumed: boolean; readonly document: CognitiveStateDocument } {
   ...
   */
  public evaluatePromotion(request: CognitivePromotionRequest): CognitivePromotionApproval {
