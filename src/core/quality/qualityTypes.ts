 ...
 */
export type TestExecutionId = string & { readonly __brand: unique symbol };

/**
 * Factory helper to construct a branded TestExecutionId.
 * Hàm hỗ trợ tạo TestExecutionId có thương hiệu.
 */
export function createTestExecutionId(id: string): TestExecutionId {
  return id as TestExecutionId;
}
 ...
 */
export type QualityReportId = string & { readonly __brand: unique symbol };

/**
 * Factory helper to construct a branded QualityReportId.
 * Hàm hỗ trợ tạo QualityReportId có thương hiệu.
 */
export function createQualityReportId(id: string): QualityReportId {
  return id as QualityReportId;
}
 ...
 */
export type QualityEvidenceId = string & { readonly __brand: unique symbol };

/**
 * Factory helper to construct a branded QualityEvidenceId.
 * Hàm hỗ trợ tạo QualityEvidenceId có thương hiệu.
 */
export function createQualityEvidenceId(id: string): QualityEvidenceId {
 ...
 */
export type QualityGateId = string & { readonly __brand: unique symbol };

/**
 * Factory helper to construct a branded QualityGateId.
 * Hàm hỗ trợ tạo QualityGateId có thương hiệu.
 */
export function createQualityGateId(id: string): QualityGateId {
  return id as QualityGateId;
}
 ...
 */
export type QualityGateOverallState =
  | 'PASS'
  | 'FAIL'
  | 'BLOCKED'
  | 'INCOMPLETE'
 ...
 */
export type QualityContradictionState =
  | 'CONSISTENT'
  | 'CONTRADICTED';
 ...
 */
export type QualityGateStageCategory =
  | 'TYPECHECK'
  | 'BUILD'
 ...
 */
export type QualityCommandType =
  | 'BUILD'
  | 'TEST'
  | 'LINT'
  | 'SECURITY'
