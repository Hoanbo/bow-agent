...
export class FleetConvergenceEvaluator {
  ...
  constructor(
    registryOrOptions: FleetNodeRegistry | FleetConvergenceEvaluatorOptions,
    emergencyStopProvider?: EmergencyStopProvider
  ) {
  ...
  public evaluate(
    ...
    let status: FleetConvergenceStatus;
    if (totalNodes === 0) {
