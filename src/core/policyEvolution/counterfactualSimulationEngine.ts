...
import type { ArchivedIncidentRecord } from '../crossIncident/crossIncidentTypes.js';
...
export class CounterfactualSimulationEngine {
  constructor(private readonly archiveStore: IncidentHistoryArchiveStore = new IncidentHistoryArchiveStore()) {}
  ...
  public simulateProposal(
    ...
    const records: readonly ArchivedIncidentRecord[] = queryResult.records;
