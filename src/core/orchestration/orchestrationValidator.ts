 ...
 */
export function containsSecurityVector(value: unknown): boolean {
 ...
 */
export function hasPrototypePollution(target: unknown): boolean {
 ...
 */
export function validateParameters(params: unknown): { valid: boolean; errors: readonly string[] } {
