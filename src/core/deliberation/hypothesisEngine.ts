...
export const LEGAL_HYPOTHESIS_TRANSITIONS: Readonly<Record<HypothesisStatus, readonly HypothesisStatus[]>> = Object.freeze({
  PROPOSED: Object.freeze(['VALIDATING', 'CONTRADICTED', 'REFUTED'] as HypothesisStatus[]),
  VALIDATING: Object.freeze(['SUPPORTED', 'REFUTED', 'CONTRADICTED', 'INCONCLUSIVE', 'SUPERSEDED'] as HypothesisStatus[]),
  SUPPORTED: Object.freeze(['CONTRADICTED', 'REFUTED', 'SUPERSEDED'] as HypothesisStatus[]),
  REFUTED: Object.freeze([] as HypothesisStatus[]),       // Terminal
  CONTRADICTED: Object.freeze([] as HypothesisStatus[]),  // Terminal
  INCONCLUSIVE: Object.freeze(['VALIDATING', 'REFUTED'] as HypothesisStatus[]),
  SUPERSEDED: Object.freeze([] as HypothesisStatus[]),    // Terminal
});
...
export class HypothesisEngine {
  ...
  public createHypothesis(
    ...
    const hypothesisId = computeDeterministicHypothesisId(
      proposal.tenantId,
      sessionId,
      sanitizedTitle,
      createdAt
    ...
    const finalHypo: DeliberationHypothesis = Object.freeze({
      ...draft,
      provenanceHash,
    });
   ...
   */
  public transitionHypothesis(
    hypo: DeliberationHypothesis,
    ...
    const updatedHypo: DeliberationHypothesis = Object.freeze({
      ...draft,
      provenanceHash,
    });
