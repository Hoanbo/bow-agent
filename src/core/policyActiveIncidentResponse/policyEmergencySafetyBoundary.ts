...
export class PolicyEmergencySafetyBoundary {
  ...
  private readonly boundaryStates: Map<string, SafetyBoundaryState> = new Map();
   ...
   */
  public activateSafetyBoundary(
    tenantPartition: string,
    incidentId: ActiveIncidentId,
    status: SafetyBoundaryStatus,
    reason: string
  ): SafetyBoundaryState {
    this.assertUserStopInactive();

    const activation: SafetyBoundaryState = Object.freeze({
   ...
   */
  public getBoundaryState(tenantPartition: string): SafetyBoundaryState | null {
    this.assertUserStopInactive();
   ...
   */
  public deactivateSafetyBoundary(
    tenantPartition: string,
    operatorId: string,
    rationale: string
  ): boolean {
