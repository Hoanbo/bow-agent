...
export class PolicyActivePolicyDegradationDetector {
   ...
   */
  public detectDegradation(resolved: ResolvedPolicyIncidentSignals): DegradationEvaluationResult {
    ...
    let overallSeverity: IncidentSeverity = 'NORMAL';
    let primaryCategory: DegradationCategory | null = null;
