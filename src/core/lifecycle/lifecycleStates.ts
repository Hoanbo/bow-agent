 ...
 */
export const OPERATIONAL_STATES: ReadonlySet<LifecycleState> = Object.freeze(new Set<LifecycleState>([
  'INITIALIZING',
  'READY',
  'RECEIVING',
  'CONTEXT_LOADING',
 ...
 */
export const TERMINAL_STATES: ReadonlySet<LifecycleState> = Object.freeze(new Set<LifecycleState>([
  'COMPLETED',
  'REJECTED',
  'BLOCKED',
  'CANCELLED',
 ...
 */
export const CONTROLLED_EXIT_STATES: ReadonlySet<LifecycleState> = Object.freeze(new Set<LifecycleState>([
  'NO_ACTION',
 ...
 */
export function isOperationalState(state: LifecycleState): boolean {
 ...
 */
export function isControlledExitState(state: LifecycleState): boolean {
 ...
 */
export function mapStateToStage(state: LifecycleState): LifecycleStage {
  switch (state) {
    case 'INITIALIZING':
    case 'READY':
