...
export class PromotionProvenanceEngine {
   ...
   */
  public static calculateEvidenceHash(
    promotionId: string,
    proposalHash: string,
    diffHash: string,
  ...
  public createEvidenceBundle(
    ...
    const evidenceHash = PromotionProvenanceEngine.calculateEvidenceHash(
      proposal.promotionId,
      proposal.provenance.proposalHash,
      proposal.diffHash,
      executionResult.previousManifestHash,
      executionResult.promotedManifestHash,
      approval.reviewerId,
      approval.decision
    );
   ...
   */
  public verifyEvidenceBundleIntegrity(bundle: PromotionEvidenceBundle): boolean {
    const expected = PromotionProvenanceEngine.calculateEvidenceHash(
      bundle.promotionId,
      bundle.proposalHash,
      bundle.diffHash,
      bundle.prePromotionManifestHash,
      bundle.postPromotionManifestHash,
      bundle.approvalRecord.reviewerId,
      bundle.approvalRecord.decision
    );
