...
export {
  ...
  type KnowledgeState,
  type KnowledgeMergeResult,
  type KnowledgeReconciliationResult,
  type KnowledgeAuditRecord,

  // Typed Errors
  GovernedFederatedKnowledgeStateError,
  ...
  GovernedFederatedKnowledgeStateLeaseError,
  GovernedFederatedKnowledgeStateBudgetError,
  GovernedFederatedKnowledgeStateConflictError,
  ...
  GovernedFederatedKnowledgeStateContinuityError,
...
export {
  ...
  type RegisterKnowledgeEntryParams,
} from './FederatedKnowledgeRegistry.js';

export {
  GovernedKnowledgeStateEngine,
  type CreateKnowledgeStateParams,
} from './GovernedKnowledgeStateEngine.js';

export {
  KnowledgeLineageEngine,
  type CreateLineageParams,
} from './KnowledgeLineageEngine.js';

export {
  KnowledgeMergeReconciliationEngine,
} from './KnowledgeMergeReconciliationEngine.js';

export {
  KnowledgeConflictResolver,
  type KnowledgeConflictResolution,
} from './KnowledgeConflictResolver.js';

export {
  CollectiveIntelligenceGovernanceEngine,
  type CollectiveIntelligenceMetrics,
} from './CollectiveIntelligenceGovernanceEngine.js';

export {
  FederatedKnowledgeSecurityBoundary,
} from './FederatedKnowledgeSecurityBoundary.js';

export {
  KnowledgeContinuityPersistenceBridge,
  type KnowledgeContinuitySnapshot,
} from './KnowledgeContinuityPersistenceBridge.js';
