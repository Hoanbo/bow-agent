 ...
 */
export const COMMIT_OPERATIONAL_STATES: ReadonlySet<CommitState> = Object.freeze(
  new Set<CommitState>([
    'COMMIT_PREPARING',
    'COMMIT_VALIDATING',
    'COMMIT_READY',
 ...
 */
export const COMMIT_TERMINAL_STATES: ReadonlySet<CommitState> = Object.freeze(
  new Set<CommitState>([
    'COMMIT_COMPLETE',
    'COMMIT_REJECTED',
    'ROLLED_BACK',
 ...
 */
export function isCommitTerminalState(state: CommitState): boolean {
 ...
 */
export function isCommitOperationalState(state: CommitState): boolean {
