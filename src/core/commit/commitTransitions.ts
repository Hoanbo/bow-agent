 ...
 */
export const VALID_COMMIT_TRANSITIONS: ReadonlyMap<CommitState, ReadonlySet<CommitState>> = Object.freeze(
  new Map<CommitState, ReadonlySet<CommitState>>([
    ['COMMIT_PREPARING', Object.freeze(new Set<CommitState>(['COMMIT_VALIDATING', 'COMMIT_FAILED', 'COMMIT_REJECTED']))],
    ['COMMIT_VALIDATING', Object.freeze(new Set<CommitState>(['COMMIT_READY', 'COMMIT_FAILED', 'COMMIT_REJECTED']))],
    ['COMMIT_READY', Object.freeze(new Set<CommitState>(['COMMITTING', 'COMMIT_FAILED', 'COMMIT_REJECTED']))],
    ['COMMITTING', Object.freeze(new Set<CommitState>(['COMMIT_CONFIRMED', 'COMMIT_FAILED']))],
    ['COMMIT_CONFIRMED', Object.freeze(new Set<CommitState>(['COMMIT_COMPLETE', 'COMMIT_FAILED']))],
    ['COMMIT_FAILED', Object.freeze(new Set<CommitState>(['ROLLBACK_PENDING', 'COMMIT_REJECTED']))],
    ['ROLLBACK_PENDING', Object.freeze(new Set<CommitState>(['ROLLED_BACK', 'COMMIT_FAILED']))],

    // Terminal states — Zero outgoing transitions permitted
    ['COMMIT_COMPLETE', Object.freeze(new Set<CommitState>([]))],
    ['COMMIT_REJECTED', Object.freeze(new Set<CommitState>([]))],
    ['ROLLED_BACK', Object.freeze(new Set<CommitState>([]))],
  ]),
);
 ...
 */
export function isValidCommitTransition(from: CommitState, to: CommitState): boolean {
 ...
 */
export function assertValidCommitTransition(from: CommitState, to: CommitState): void {
