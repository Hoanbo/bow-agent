 ...
 */
export function evaluateCommitConsistency(
  preSnapshot: PreCommitSnapshot,
  postSnapshot?: PostCommitSnapshot,
  plan?: CommitPlan,
): Readonly<ConsistencyValidationResult> {
  const issues: ConsistencyIssueType[] = [];
