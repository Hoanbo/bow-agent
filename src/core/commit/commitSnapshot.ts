...
export function createPreCommitSnapshot(params: {
  ...
  const stateFingerprint = computePreCommitSnapshotFingerprint(
    params.userId,
    params.sessionId,
    params.currentState,
    params.sequence,
...
export function createPostCommitSnapshot(params: {
  ...
  const commitFingerprint = computePostCommitSnapshotFingerprint(
    params.userId,
    params.sessionId,
    params.committedState,
    params.sequence,
    params.commitId,
  );
  ...
  const snapshot: PostCommitSnapshot = {
