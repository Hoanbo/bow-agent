...
export class OperationalHealthEvaluator {
   ...
   */
  public evaluateHealth(telemetry: HealthEvaluationTelemetry): HealthEvaluation {
    ...
    let healthState: OperationalHealthState = 'HEALTHY';
   ...
   */
  public assertAcceptableHealth(evaluation: HealthEvaluation): void {
