...
export class DurableCommitExecutionGate {
   ...
   */
  private checkCheckpoint(gateName: string, gateNumber: number, context?: DurableCommitGateContext): void {
    if (this.isUserStopActiveFn()) {
      ...
      throw new CommitAbortedError(
        `Durable commit aborted at Gate ${gateNumber} (${gateName}): USER_STOP is active (${reason})`,
   ...
   */
  public assertGate1_RequestAcceptance(context?: DurableCommitGateContext): void {
   ...
   */
  public assertGate2_StateRead(context?: DurableCommitGateContext): void {
   ...
   */
  public assertGate3_PreWrite(context?: DurableCommitGateContext): void {
   ...
   */
  public assertGate4_PostWrite(context?: DurableCommitGateContext): void {
