 ...
 */
export function computeBrainIdentity(ownerUserId: string, seed = 'BOWCON_V4_BRAIN'): { brainId: string; fingerprint: string } {
 ...
 */
export function computeSurfaceIdentity(
  surfaceType: SurfaceType,
  name: string,
  capabilities: SurfaceCapabilities,
): { surfaceId: string; fingerprint: string } {
  const capsStr = [
 ...
 */
export function computeContinuityFingerprint(
  brainId: string,
  userId: string,
  sessionId: string,
  sequence: number,
 ...
 */
export function computeHandoffFingerprint(
  handoffId: string,
  brainId: string,
 ...
 */
export function computeCoordinationRecordFingerprint(
  recordId: string,
  brainId: string,
  sequence: number,
  action: string,
 ...
 */
export function computeCoordinationCheckpointFingerprint(
  checkpointId: string,
  brainId: string,
  sequence: number,
): string {
 ...
 */
export function computeCoordinationFailureFingerprint(
