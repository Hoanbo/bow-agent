 ...
 */
export function generateVaultId(seed: unknown): string {
 ...
 */
export function generateVaultEntryId(deviceId: string, keyId: string, version: number): string {
 ...
 */
export function generateVaultRecordId(deviceId: string, scopeString: string): string {
 ...
 */
export function isValidVaultEntryId(id: unknown): id is string {
 ...
 */
export function isValidVaultRecordId(id: unknown): id is string {
