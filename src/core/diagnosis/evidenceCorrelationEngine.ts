...
export class EvidenceCorrelationEngine {
  public static readonly DEFAULT_WINDOW_DURATION_MS = 60_000; // 1 minute window
   ...
   */
  public correlate(input: EvidenceCorrelationInput): CorrelatedEvidenceCluster {
    ...
    const evidenceItems: CorrelatedEvidenceItem[] = [];
    ...
    const clusterId = createEvidenceClusterId(
      `cluster_${refTime}_${clusterHash.substring(0, 10)}`
    );
