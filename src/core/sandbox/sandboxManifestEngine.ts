...
export class SandboxManifestEngine {
  constructor(private readonly fsEngine: SandboxFilesystemEngine) {}
   ...
   */
  public static scanProjectDirectory(projectRoot: string): SandboxEntry[] {
   ...
   */
  public static calculateManifestHash(entries: readonly SandboxEntry[]): string {
   ...
   */
  public verifyManifestIntegrity(manifest: SandboxManifest): boolean {
