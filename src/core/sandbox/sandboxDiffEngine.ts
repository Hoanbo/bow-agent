...
export class SandboxDiffEngine {
   ...
   */
  public static calculateDiffHash(changes: readonly SandboxChange[]): string {
  ...
  public generateDiff(
    ...
    const baseMap = new Map<string, SandboxEntry>();
   ...
   */
  public verifyDiffIntegrity(diff: SandboxDiff): boolean {
