...
export class ReleaseExecutionManifestEngine {
   ...
   */
  public static scanDirectory(dirPath: string): ReleaseExecutionManifest {
    ...
    const fileEntries: { relativePath: string; sha256: string; sizeBytes: number }[] = [];
   ...
   */
  public static compareManifests(
    a: ReleaseExecutionManifest,
    b: ReleaseExecutionManifest
  ): {
