...
export class ReleaseExecutionProvenanceEngine {
   ...
   */
  public static calculateExecutionHash(request: ReleaseExecutionRequest): string {
    const payload = [
      request.executionId,
      request.candidateId,
   ...
   */
  public static calculateResultHash(
    executionId: string,
    candidateId: string,
    state: ReleaseExecutionState,
    preManifestHash: string,
    postManifestHash: string | undefined,
   ...
   */
  public static assembleEvidence(
    ...
    const evidenceHash = ReleaseExecutionProvenanceEngine.calculateEvidenceHash(
      request.executionId,
      request.candidateId,
      request.verificationId,
      preManifestHash,
   ...
   */
  public static compileResult(params: {
    request: ReleaseExecutionRequest;
    state: ReleaseExecutionState;
    ...
    const resultHash = ReleaseExecutionProvenanceEngine.calculateResultHash(
      params.request.executionId,
      params.request.candidateId,
      params.state,
      params.preReleaseManifestHash,
      params.postReleaseManifestHash,
      params.filesMutated,
      params.completedAt
    );
