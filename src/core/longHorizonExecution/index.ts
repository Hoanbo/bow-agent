...
export {
  ...
  type LongHorizonAutonomyBudget as AutonomyBudget,
  type LongHorizonResourceUsage,
  type GovernedLongHorizonObjective,
  type GovernedLongHorizonObjective as LongHorizonObjectiveEnvelope,
  type LongHorizonGeneration,
  type LongHorizonProgressRecord,
  type LongHorizonProgressRecord as ProgressCheckpoint,
...
export {
  ...
  computeLongHorizonGenerationProvenanceHash as computeGenerationProvenanceHash,
  computeLongHorizonProgressProvenanceHash,
  computeLongHorizonProgressProvenanceHash as computeProgressProvenanceHash,
...
} from './objectiveProgressEvaluator.js';
...
} from './longHorizonAutonomySecurityBoundary.js';
...
} from './longHorizonAuditBridge.js';

// 10. Persistence & Recovery Engine
export {
  LongHorizonPersistenceRecoveryEngine,
  type PersistenceEngineOptions as LongHorizonPersistenceEngineOptions,
} from './longHorizonPersistenceRecoveryEngine.js';

// 11. Master Governed Long-Horizon Orchestrator
export {
  GovernedLongHorizonOrchestrator,
  type LongHorizonOrchestratorOptions,
  type ExecuteObjectiveParams,
} from './governedLongHorizonOrchestrator.js';
