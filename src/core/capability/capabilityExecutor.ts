...
import { WorldActionExecutor, validateAndResolvePath } from '../world-action/worldActionExecutor.js';
      ...
      switch (descriptor.capabilityId) {
        ...
        default:
          throw new CapabilityError(
            'UNAVAILABLE',
            `No physical execution adapter registered for capability "${descriptor.capabilityId}".`,
