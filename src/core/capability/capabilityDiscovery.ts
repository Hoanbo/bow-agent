...
import type { HostEnvironmentSnapshot, HostMode, HostNetworkInterface } from './capabilityTypes.js';

export class CapabilityDiscoveryEngine {
  /**
   * Captures a real host environment snapshot directly from operating system APIs.
   */
  public captureSnapshot(): HostEnvironmentSnapshot {
    const cpus = os.cpus() || [];
    ...
    const networkInterfaces: HostNetworkInterface[] = [];
    let isOnline = false;
   ...
   */
  public detectHostMode(cores: number, totalMemBytes: number): HostMode {
