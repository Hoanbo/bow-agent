...
export class RemediationRollbackEngine {
   ...
   */
  public async executeRollback(options: ExecuteRollbackOptions): Promise<RemediationRollbackResult> {
  ...
  public computeRollbackSha256(
    executionId: RemediationExecutionId,
    snapshotId: string,
    success: boolean,
    restoredItems: readonly string[]
  ): string {
