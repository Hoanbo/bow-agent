import { searchProducts, type ProductItemResult } from './tools.js';
...
const registeredCapabilityTerms = new Set<string>();
 ...
 */
export function registerProductCapabilityTerms(terms: string[]): void {
  for (const t of terms) {
    if (t) registeredCapabilityTerms.add(normalizeString(t));
  }
}

export function getProductCapabilityTerms(): Set<string> {
