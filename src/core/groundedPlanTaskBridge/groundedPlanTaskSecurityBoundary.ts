...
export class GroundedPlanTaskSecurityBoundary {
   ...
   */
  public assertTenantMatches(requestedTenant: string, activeTenant: string): void {
   ...
   */
  public assertSessionMatches(requestedSession: string, activeSession: string): void {
    if (this.userStopProvider()) {
