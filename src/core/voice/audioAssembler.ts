...
export class AudioAssembler {
   ...
   */
  public static createPcmSilence(durationMs: number, sampleRate: number = 16000): Buffer {
   ...
   */
  public static isValidWavBuffer(buf: Buffer): { valid: boolean; sampleRate?: number; dataOffset?: number; dataSize?: number; error?: string } {
   ...
   */
  public static assembleWav(chunks: AudioChunk[], defaultSampleRate: number = 16000): Buffer {
   ...
   */
  public static assemblePcm(chunks: AudioChunk[], sampleRate: number = 16000): Buffer {
    if (!chunks || chunks.length === 0) {
      throw new VoiceSynthesisError('Cannot assemble empty chunks array');
    }
   ...
   */
  public static assembleMp3(chunks: AudioChunk[]): Buffer {
    if (!chunks || chunks.length === 0) {
      throw new VoiceSynthesisError('Cannot assemble empty chunks array');
    }
   ...
   */
  public static assemble(chunks: AudioChunk[], format: AudioOutputFormat = 'audio/wav', sampleRate?: number): Buffer {
    if (!chunks || chunks.length === 0) {
