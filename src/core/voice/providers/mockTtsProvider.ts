...
export class MockTtsProvider implements TTSProvider {
  ...
  private simulatedFailure: string | null = null;
  private mockSupportsSentenceLevel: boolean = true;
  private mockSupportsSsml: boolean = true;
  ...
  public setSimulatedFailure(errorMessage: string | null): void {
    this.simulatedFailure = errorMessage;
  }

  public setSupportsSentenceLevel(supported: boolean): void {
    this.mockSupportsSentenceLevel = supported;
  }

  public setSupportsSsml(supported: boolean): void {
   ...
   */
  public static createValidWavBuffer(durationMs: number, sampleRate: number = 16000): Buffer {
    const numChannels = 1;
