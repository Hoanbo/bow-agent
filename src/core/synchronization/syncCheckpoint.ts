 ...
 */
export function createSyncCheckpoint(params: CreateSyncCheckpointParams): SyncCheckpoint {
  ...
  if (
    ...
    throw new Error(
      `[SYNCHRONIZATION_CHECKPOINT_ERROR] Invalid checkpoint sequence ${params.sequence}. Must be non-negative integer.`,
    );
  }
