...
export class PolicyEvolutionIntakeEngine {
  ...
  private readonly intakes: Map<string, Map<string, PolicyEvolutionIntakeRequest>> = new Map();
  ...
  private getTenantIntakes(tenantPartition: string): Map<string, PolicyEvolutionIntakeRequest> {
   ...
   */
  public mapActionType(proposedAction: string): EvolutionIntakeActionType | undefined {
  ...
  public createIntakeRequest(
    ...
    decisionRecord: HumanReviewDecisionRecord,
    provenanceHeadHash: string
    ...
    const intakeRequest: PolicyEvolutionIntakeRequest = Object.freeze({
      intakeId,
  ...
  public getIntakeRequest(tenantPartition: string, reviewId: string): PolicyEvolutionIntakeRequest | undefined {
    ...
    return this.getTenantIntakes(tenantPartition).get(reviewId as any);
  }
}
