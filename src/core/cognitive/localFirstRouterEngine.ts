...
export class LocalFirstRouterEngine {
  public readonly localRuntime: LocalFirstOllamaRuntime;
  ...
  public readonly cloudEscalationPolicy: CloudEscalationPolicy;
  ...
  public async route(
    ...
    const checkStop = (checkpoint: string) => {
    ...
    const isCloudPermitted =
      this.cloudEscalationPolicy.enabled &&
