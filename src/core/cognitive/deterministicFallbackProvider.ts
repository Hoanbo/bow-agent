...
export class DeterministicFallbackProvider implements CognitiveProvider {
  public readonly providerType: CognitiveProviderType = 'deterministic-fallback';
  public readonly providerName = 'deterministic-local-fallback';
  ...
  public async process(
    ...
    let toolArgs: Record<string, unknown> = { input: safeInput };
    ...
    const toolCandidates: readonly CognitiveToolCandidate[] = [
      {
        toolName,
        toolArgs,
