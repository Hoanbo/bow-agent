...
export class CognitivePipeline {
  ...
  private readonly idempotencyCache = new Map<string, CognitiveResult>();
  ...
  public getRegistry(): CognitiveRegistry {
    return this.registry;
  }

  public getContextReconstructor(): ContextReconstructor {
   ...
   */
  public async execute(req: CognitivePipelineRequest): Promise<CognitiveResult> {
    ...
    const promptContext: CognitivePromptContext = {
    ...
    let cognitiveResult: CognitiveResult;
    ...
    const isDangerous =
      cognitiveResult.riskLevel === 'HIGH' ||
    ...
    const finalResult: CognitiveResult = {
      ...
      decision: {
        ...
        executionEligibility:
          cognitiveResult.decision.executionEligibility &&
