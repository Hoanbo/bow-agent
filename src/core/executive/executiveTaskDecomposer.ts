...
export class ExecutiveTaskDecomposer {
  public decompose(goal: ExecutiveGoal, customTaskSpecs?: CreateTaskOptions[]): DecompositionResult {
    const graph = new ExecutiveDependencyGraph();
    const createdTasks: ExecutiveTask[] = [];
    ...
    return Object.assign([...createdTasks], {
      ...
      rootTasks,
      leafTasks,
    }) as unknown as DecompositionResult;
  }
}
