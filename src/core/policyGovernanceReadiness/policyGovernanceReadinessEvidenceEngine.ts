...
export class PolicyGovernanceReadinessEvidenceEngine {
   ...
   */
  public evaluateAll(context: EvidenceEngineContext): readonly CriterionEvaluationResult[] {
  ...
  private evaluateCriterion(
    criterion: ReadinessCriterionDefinition,
    ...
    if (context.overrides && context.overrides[criterion.criterionId]) {
      ...
      const record: CriterionEvidenceRecord = Object.freeze({
    ...
    let status: CriterionStatus = 'NOT_TESTED';
    let reason = '';
    let risk = 'NONE';
    ...
    const evidence: CriterionEvidenceRecord = Object.freeze({
