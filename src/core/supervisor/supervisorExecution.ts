...
import type { RecoveryPlan, RecoveryStep } from './supervisorTypes.js';
...
export class SupervisorExecutionEngine {
  ...
  private async executeStep(step: RecoveryStep, options?: { authorizationToken?: any }): Promise<void> {
    ...
    throw new SupervisorError(
      'UNAVAILABLE',
      `No physical recovery adapter configured for step "${step.description}".`
    );
  }
}
