 ...
 */
export function canonicalizePersistentData(val: unknown): string {
 ...
 */
export function fnv1a32Device(input: string): number {
 ...
 */
export function computeDeviceDigest(data: unknown): string {
 ...
 */
export function computeDeviceFingerprint(data: unknown): string {
 ...
 */
export function computeDeviceCapabilityFingerprint(capabilities: readonly string[]): string {
 ...
 */
export function deepFreezeDevice<T>(obj: T): T {
