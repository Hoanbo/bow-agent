...
export class PolicyCanaryProvenanceEngine {
  ...
  private readonly chains = new Map<string, CanaryProvenanceRecord[]>();
  ...
  public recordEvent(input: {
    ...
    const provenanceId = createPolicyCanaryProvenanceId(
    ...
    const record: CanaryProvenanceRecord = {
      provenanceId,
      candidateId,
      tenantPartition,
      ring,
   ...
   */
  public verifyChain(candidateId: PolicyCandidateId): {
   ...
   */
  public getChain(candidateId: PolicyCandidateId): readonly CanaryProvenanceRecord[] {
