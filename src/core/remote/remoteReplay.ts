...
export type RemoteReplayClassification =
  | 'ACCEPTED_NEW'
 ...
 */
export function analyzeRemoteReplay(
  historyBySeq: ReadonlyMap<number, Readonly<RemoteRequest>>,
  historyById: ReadonlyMap<string, Readonly<RemoteRequest>>,
  incoming: Readonly<RemoteRequest>,
  expectedSessionId: string,
): Readonly<RemoteReplayResult> {
