...
import type { ToolCapability, CapabilityParameter } from './capabilityTypes.js';
import type { CapabilityRegistry } from './capabilityRegistry.js';

export const mockEchoCapability: ToolCapability = Object.freeze({
  name: 'mock.echo',
  description: 'Deterministic echo capability for execution testing.',
  domain: 'mock',
  risk: 'LOW',
  parameters: Object.freeze<CapabilityParameter[]>([
...
export const mockCalculateCapability: ToolCapability = Object.freeze({
  name: 'mock.calculate',
...
export const mockLookupCapability: ToolCapability = Object.freeze({
  name: 'mock.lookup',
...
export const mockHighRiskCapability: ToolCapability = Object.freeze({
...
export const mockCriticalRiskCapability: ToolCapability = Object.freeze({
 ...
 */
export function registerMockCapabilities(registry: CapabilityRegistry): void {
