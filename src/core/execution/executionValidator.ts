 ...
 */
export function containsSecret(val: unknown): boolean {
 ...
 */
export function redactExecutionSecrets(text: string): string {
 ...
 */
export function hasExecutionPrototypePollution(target: unknown): boolean {
...
export function isSafePath(pathStr: string): boolean {
  ...
  if (WINDOWS_RESERVED_DEVICE_NAMES.has(baseName)) return false;
