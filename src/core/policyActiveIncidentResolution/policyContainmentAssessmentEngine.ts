...
export class PolicyContainmentAssessmentEngine {
   ...
   */
  public assessContainment(input: ContainmentAssessmentInput): ContainmentAssessmentRecord {
    ...
    let status: ContainmentAssessmentStatus = 'CONTAINED';
    ...
    return Object.freeze({
      ...
      isAutonomousClearance: false as const,
      isDirectToolExecution: false as const,
    });
  }
}
