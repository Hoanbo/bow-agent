...
export class PolicyIncidentResolutionEngine {
   ...
   */
  public evaluateResolution(input: IncidentResolutionInput): IncidentResolutionRecord {
    ...
    let resolutionMode: 'RECOVERY_VERIFIED' | 'RESOLVED_WITHOUT_RECOVERY' = 'RECOVERY_VERIFIED';
    ...
    const status: ResolutionConfirmationStatus = isConfirmed ? 'CONFIRMED' : 'REJECTED';
    ...
    return Object.freeze({
      ...
      isAutonomousClosure: false as const,
