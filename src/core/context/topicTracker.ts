...
export class TopicTracker {
   ...
   */
  public detectTopic(text: string): { activeTopic: string; topicConfidence: number } {
   ...
   */
  public inferTopic(text: string): { topic: string; confidence: number } {
   ...
   */
  public updateTopic(
    currentState: TopicState | undefined,
    currentText: string,
    turnId?: string
  ): TopicState {
