...
export class ContextRanker {
   ...
   */
  public scoreItem(item: ContextItem, activeTopic?: string, indexFromEnd: number = 0): number {
    let score = 0;
   ...
   */
  public rankItems(items: ContextItem[], options: RankingOptions = {}): ContextItem[] {
