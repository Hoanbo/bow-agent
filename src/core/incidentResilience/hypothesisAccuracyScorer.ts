...
import type {
  HypothesisAccuracyRecord,
  HypothesisOutcomeClassification,
...
export class HypothesisAccuracyScorer {
   ...
   */
  public scoreHypothesis(input: ScoreHypothesisInput): HypothesisAccuracyRecord {
    const {
      hypothesis,
      actionClass,
      verificationResult,
  ...
  private isActionCategoryAligned(
    category: string,
    actionClass?: RemediationActionClass
  ): boolean {
