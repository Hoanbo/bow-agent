 ...
 */
export function createNetworkFailureDescriptor(
  params: CreateNetworkFailureParams,
): Readonly<NetworkFailureDescriptor> {
  ...
  const failure: NetworkFailureDescriptor = {
    failureId: `fail_${fp}`,
    code: params.code,
    message: scrubbedMessage,
    networkConnectionId: params.networkConnectionId,
