...
export const ALL_NETWORK_ADAPTER_TYPES: ReadonlySet<NetworkAdapterType> = Object.freeze(
  new Set<NetworkAdapterType>(['IN_MEMORY', 'LOCAL', 'LAN', 'REMOTE']),
);
...
export const ALL_NETWORK_DIRECTIONS: ReadonlySet<NetworkDirection> = Object.freeze(
  new Set<NetworkDirection>(['INBOUND', 'OUTBOUND', 'BIDIRECTIONAL']),
);
...
export const ALL_NETWORK_PROTOCOL_MODES: ReadonlySet<NetworkProtocolMode> = Object.freeze(
  new Set<NetworkProtocolMode>(['FRAMED_MESSAGE', 'STREAM', 'REQUEST_RESPONSE']),
);
...
export const ALL_NETWORK_EVENT_TYPES: ReadonlySet<NetworkEventType> = Object.freeze(
  new Set<NetworkEventType>([
    'CONNECTION_REQUESTED',
    'CONNECTION_ACCEPTED',
    'CONNECTION_REJECTED',
    'CONNECTION_OPENED',
...
export type NetworkFailureCode =
  ...
  | 'REPLAY_CONFLICT'
  | 'NETWORK_BACKPRESSURE_BLOCKED'
  | 'ADAPTER_UNAVAILABLE'
  | 'PROTOTYPE_POLLUTION_DETECTED'
  | 'NULL_BYTE_DETECTED'
  | 'PATH_TRAVERSAL_DETECTED'
  | 'WINDOWS_DEVICE_NAME_DETECTED'
  | 'SECRET_DETECTED'
  | 'PROTOCOL_MISMATCH';
