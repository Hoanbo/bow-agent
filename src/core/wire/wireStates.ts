...
export const ALL_WIRE_STATES: readonly WireConnectionState[] = Object.freeze([
  'WIRE_DISCONNECTED',
  'WIRE_CONNECTING',
  'WIRE_CONNECTED',
  'WIRE_HANDSHAKING',
 ...
 */
export function isWireActive(state: WireConnectionState): boolean {
 ...
 */
export function isWireTerminal(state: WireConnectionState): boolean {
 ...
 */
export function canTransmitWirePayload(state: WireConnectionState): boolean {
  return state === 'WIRE_ACTIVE' || state === 'WIRE_DEGRADED';
}
 ...
 */
export function isWireHandshakingOrValidating(state: WireConnectionState): boolean {
  return (
    state === 'WIRE_HANDSHAKING' ||
 ...
 */
export function isWireReconnectingOrResuming(state: WireConnectionState): boolean {
 ...
 */
export function isWireDraining(state: WireConnectionState): boolean {
