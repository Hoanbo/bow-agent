...
export const ALL_NETWORK_TYPES: readonly NetworkType[] = Object.freeze([
  'WIFI',
  'CELLULAR_4G',
  'CELLULAR_5G',
  'WIRED',
 ...
 */
export type AdmissionDecisionType =
  | 'ADMIT'
  | 'REJECT'
  | 'CHALLENGE_REQUIRED'
...
export const ALL_ADMISSION_DECISION_TYPES: readonly AdmissionDecisionType[] = Object.freeze([
  'ADMIT',
  'REJECT',
  'CHALLENGE_REQUIRED',
  'REAUTHENTICATION_REQUIRED',
...
export const ALL_ADMISSION_REJECTION_REASONS: readonly AdmissionRejectionReason[] = Object.freeze([
  'UNTRUSTED_NETWORK_REJECTED',
  'INVALID_PROOF',
  'REPLAY_DETECTED',
  'DEVICE_REVOKED',
 ...
 */
export type AdmissionSecurityEventType =
  | 'ADMISSION_REQUESTED'
  | 'ADMISSION_ADMITTED'
  | 'ADMISSION_REJECTED'
  | 'CHALLENGE_ISSUED'
...
export const ALL_ADMISSION_SECURITY_EVENT_TYPES: readonly AdmissionSecurityEventType[] = Object.freeze([
  'ADMISSION_REQUESTED',
  'ADMISSION_ADMITTED',
  'ADMISSION_REJECTED',
  'CHALLENGE_ISSUED',
