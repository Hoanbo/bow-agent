// scratch/scan_ms_1_4_13_security.mjs
// BOWCON V4.0 — MS-1.4.13 SECURITY SCANNER
// Scans src/core/phase14ExitBoundary/ for prohibited process, dynamic, network, bypass, loop, or future tokens

import fs from 'node:fs';
import path from 'node:path';

const TARGET_DIR = path.resolve('src/core/phase14ExitBoundary');
...
if (totalViolations > 0) {
  console.error(`\nSECURITY SCAN FAILED: Found ${totalViolations} forbidden tokens in MS-1.4.13.`);
  process.exit(1);
}
